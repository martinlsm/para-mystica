...
class ActionButton:
    def __init__(self, app_ctrl, master, label, grid_row, grid_col):
    ...
    def _on_press(self):
        self.app_ctrl.append_game_event(self.label)
        print(f'Pressed "{self.label}"')


class NextRoundButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Next Round', grid_row, grid_col)


class UpgradeDiggingButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Upgrade Digging', grid_row, grid_col)


class UpgradeShippingButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Upgrade Shipping', grid_row, grid_col)


class DigButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Dig', grid_row, grid_col)


class BuildDwellingButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Build Dwelling', grid_row, grid_col)


class UpgradeToTPButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Upgrade to Trading Post',
                     grid_row, grid_col)


class UpgradeToTEButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Upgrade to Temple', grid_row, grid_col)


class UpgradeToSAButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Upgrade to Sanctuary', grid_row,
                     grid_col)


class UpgradeToSHButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Upgrade to Stronghold', grid_row,
                     grid_col)


class TunnelingButton:
    def __init__(self, app_ctrl, master, grid_row, grid_col):
        ActionButton(app_ctrl, master, 'Tunneling', grid_row, grid_col)
